  ...
  kvant: `<model-viewer id="modkvant" 
    ...
    mojaysky: `<model-viewer id="modmoj" 
        ...
        <button class="hotspot_a" slot="hotspot-1" 
                ...
                data-normal="0 1 0"
                data-visibility-attribute="visible">
            <div class="annotation">Прототип первого российского самолёта <br> Пружинный двигатель и три винта</div>
        </Button>       
        ...
        <button class="hotspot_a" slot="hotspot-5" 
                ...
                data-normal="1 0 0"
                data-visibility-attribute="visible">
            <div class="annotation"> Успешно летала в 1876–1877 годах, доказывая верность расчетов конструктора <br>В учебных ангарах МАИ представлен макет консоли крыла этого исторического аппарата.</div>
        </button> 
        <!-- Индикатор загрузки -->
        <div slot="progress-bar" class="custom-loader">
           <div class="loader-text">Загрузка модели...</div>
...
const data={
  ...
  mojaysky: {
    ...
    text: 'Успешно летающая масштабная модель, послужившая прототипом для создания первого в России полноразмерного самолета (1882 г.)',
    history: 'Создана морским офицером Александром Фёдоровичем Можайским в 1876 году для проверки аэродинамических расчетов. В 1877 году демонстрировалась Главным инженерным управлением и подтвердила возможность полета тяжелее воздуха.',
